...
export const Logo: React.FC<LogoProps> = ({ size = "md", variant = "dark", showIcon = true }) => {
    const sizes = {
        ...
        <div className={`flex items-center gap-3 ${currentSize.container}`}>
            {showIcon && (
                <div className="relative">
                    <svg width={currentSize.icon} height={currentSize.icon} viewBox="0 0 80 80" className="relative z-10">
                        {/* Outer circle - subtle */}
                        <circle cx="40" cy="40" r="35" fill="none" stroke="#e5e5e5" strokeWidth="1.5" />

                        {/* Inner gradient circle */}
                        <circle cx="40" cy="40" r="30" fill="none" stroke="url(#logoGradient)" strokeWidth="2" opacity="0.4" />
                        ...
                        {/* Accent dot */}
                        <circle cx="54" cy="20" r="3.5" fill="#ff6b6b" />
